function [nlyrs,dlyrsx, dlyrsy]=createmesh3dfmm_138(L,ste,xalpha,ix,dx,dy,dz,w1,w2,w3,w4,w11,w21,w31,w41,gl,gr,sptw,yCladBot,hWg1,hWg2,yCladTop,nBelow,nCore,nAbove,ifplot,ypos,ypos1,k)
%Lx x xip dimension 
%Ly y xip dimension 
%l coupling length
...
%m upper margin distance% example Lx=100; Ly=50; l=30; g=0.5; w = 0.3; m=4; dx= 0.01; dy = 0.01; 
...
%dd=du-wdl+recta(xx,0,0,1,wdl-wdr);
%du=spline(xL,yzL,xx);
dd1=repmat(ypos1(1:(k+1)),length(y),1)+sptw;
...
save('CLO2020bpglayout_synthesised_magicteedevice1550_25.mat', 'tv', 'bv','l','w1','w2','w3','w4','tv1', 'bv1','w11','w21','w31','w41','wout','ste','cof','gl','gr','bendy','bendx','bendxin','lam'); 
save('CLO2020bottom_bv_synthesised_magicteedevice1550_25_movedby25.mat', 'bv');
bv=bv1;
figure;
plot(bv(:,1),bv(:,2))
save('CLO2020top_bv_synthesised_magicteedevice1550_25_movedby25.mat', 'bv');
