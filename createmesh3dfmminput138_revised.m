function [nlyrs,dlyrsx, dlyrsy]=createmesh3dfmminput138(L,ste,xalpha,ix,dx,dy,dz,w1,w2,w3,w4,w11,w21,w31,w41,gl,gr,sptw,yCladBot,hWg1,hWg2,yCladTop,nBelow,nCore,nAbove,ifplot,ypos,ypos1,k)
%Lx x xip dimension 
%Ly y xip dimension 
%l coupling length
...
save('bpglayout_synthesisedinput_magicteedevice1550_1_movedby25.mat', 'tv', 'bv','l','w1','w2','w3','w4','tv1', 'bv1','w11','w21','w31','w41','wout','ste','cof','gl','gr','bendy','bendx','bendxin','lam'); 
save('bottom_bv_synthesisedinput_magicteedevice1550_1_movedby25.mat', 'bv');
bv=bv1;
figure;
plot(bv(:,1),bv(:,2))
save('top_bv_synthesisedinput_magicteedevice1550_1_movedby25.mat', 'bv');
